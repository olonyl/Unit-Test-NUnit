...
namespace TDD_UnitTest.TicTacToe
{
    public class Game
    {
        ...
        private Winner GetWinner(params int[] indexes)
        {
            ...
            if(MovesCounter < 9 ) return Winner.GameIsUnfinished;
        ...
        public override string ToString()
        {
            ...
            if (winner == Winner.Draw || winner == Winner.GameIsUnfinished) return $"This game is {winner.ToString()}";
            return $"Result: {this.GetWinner()} wins the Game!!";
        }
    }
}
