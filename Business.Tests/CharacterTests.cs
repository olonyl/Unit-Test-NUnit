...
namespace Business.Tests
{
    public class CharacterTests
    {
        ...
        {
            const string expectedUpperCase = "JHON";
            const string expectedLowerCase = "jhon";
        ...
        #region Types
        [Test]
        public void TestObjectOfCharacterTypes()
        {
        ...
        #region Ranges
        [Test]
        public void DefaultCharacterArmorShouldBeGreaterThat30AndLessThan100()
        {
            Character c = new Character(Type.Elf);
        ...
        #region Exceptions
        [Test]
        public void Damage_100_ThrowsArgumentOutOfRange()
        {
            var c = new Character(Type.Elf);
