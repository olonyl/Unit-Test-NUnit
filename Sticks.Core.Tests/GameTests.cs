...
namespace Sticks.Core.Tests
{
    public class GameTests
    {
        ...
        public void MachineMakesMove_CorrectGameState(int takes, int remains)
        {
            ...
            sut.MachineMoved += (sut, args) => taken = args.Taken;
        ...
        [TestCase(1, false)]
        [TestCase(2, true)]
        public void IsGameOver_SomeSticks_returnsCorrectResults(int takeWhenThwoSticksInGame, bool isOver)
        {
            Game sut = ReduceTo2SticksStartingWithHuman();
            sut = sut.HumanMakesMove(takeWhenThwoSticksInGame);
        ...
        private Game ReduceTo2SticksStartingWithHuman()
        {
            var gen = new PredictableGenerator();
        ...
        public void Ctor_NullGenerator_Throws()
        {
            ...
            {
                new Game(10, Player.Machine, null);
            });
        }
    }
